...
<body>
    ...
    <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=31fb8a8341715ab7f179a87d896d98a8&libraries=services"></script>
    <script>
        $(document).ready(function () {
            var mapContainer = document.getElementById('kakao-map'); // 지도를 표시할 div
            var mapOption = {
                center: new kakao.maps.LatLng(37.528582, 126.981987), // 지도의 중심좌표
                level: 4 // 지도의 확대 레벨
            };
            ...
            // 주소로 좌표를 검색합니다
            geocoder.addressSearch('경기도 수원시 권선구 고색동 215-1', function (result, status) {
                ...
                if (status === kakao.maps.services.Status.OK) {
                    ...
                    var infowindow = new kakao.maps.InfoWindow({
                        content: '<div style="width:220px;text-align:center;padding:6px 0;">'
                               + '<strong>힘찬 부동산</strong><br>경기도 수원시 권선구 고색동 215-1'
                               + '</div>'
                    });
